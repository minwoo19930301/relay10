...
Relay10's plugin and skill text are original clean-room work released under the repository's MIT license. No third-party prompt, script, asset, or implementation file was copied into this pack.
...
- `openai/skills` is deprecated and is retained only as historical evidence. Current Codex packaging follows `openai/plugins` and official Codex documentation.
